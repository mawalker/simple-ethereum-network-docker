...
if __name__ == '__main__':
    ...
    # Must give <this-script> <ip> <port>

    # get client's current number of peers (in hex format)
    getPeerCount(ip=sys.argv[1],port=sys.argv[2],verbose='True')

    # get client's current block number
    getBlockNumber(ip=sys.argv[1],port=sys.argv[2],verbose='True')
